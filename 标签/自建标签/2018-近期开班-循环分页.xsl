            ...
            <xsl:for-each select="NewDataSet/Table">
                <Table>
                    ...
                    <InfoPath>
                        ...
                        &lt;div class="u-btn mt-5"&gt;&lt;a href="<xsl:value-of select="pe:GetInfoPath(NodeID,GeneralID,InputTime,PinyinTitle,HtmlPageName)"/>" class="mr-3"&gt;了解详情&lt;/a&gt; &lt;a href=""&gt;点击咨询&lt;/a&gt;&lt;/div&gt;
                        &lt;/div&gt;
                        &lt;/div&gt;
                        &lt;/div&gt;
                    </InfoPath>
